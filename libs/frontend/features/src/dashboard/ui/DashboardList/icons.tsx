...
export const TotalStudentsIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg
...
export const InProgressIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ScheduledIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const GraduatedIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const EgressedIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const TotalAdmissionsIcon = ({
  className = '',
  size = 24,
}: IconProps) => (
  <svg
...
export const TotalEgressesIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const GraduationRateIcon = ({
  className = '',
  size = 24,
}: IconProps) => (
  <svg
